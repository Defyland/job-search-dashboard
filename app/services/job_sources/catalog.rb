module JobSources
  class Catalog
    ...
    DEFAULTS = [
      ...
      {
        name: "Allied Global ITS",
        slug: "allied-global-its",
        source_kind: :ats,
        base_url: "https://allied-global-its.talentlyft.com",
        host: "talentlyft.com",
        priority: 24,
        ...
        scan_window_days: 20,
        settings: {
          board_urls: [ "https://allied-global-its.talentlyft.com" ],
          max_jobs: 12
        }
      },
      {
        ...
        scan_window_days: 20,
        settings: {
          board_urls: [ "https://customertimes.careers-page.com" ],
          max_jobs: 12
        }
      },
