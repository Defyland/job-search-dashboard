module JobDiscovery
  class Registry
    ADAPTERS = {
      ...
      "braintrust_jobs_api" => JobDiscovery::Adapters::BraintrustJobsApiAdapter,
      "careers_page_company_boards" => JobDiscovery::Adapters::CareersPageCompanyBoardsAdapter,
      ...
      "talentlyft_board_sitemap" => JobDiscovery::Adapters::TalentlyftBoardSitemapAdapter,
