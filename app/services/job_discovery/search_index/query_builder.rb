  ...
  module SearchIndex
    class QueryBuilder
      ...
      TARGETS = [
        ...
        { source_slug: "greenhouse", host: "boards.eu.greenhouse.io", setting_key: "board_tokens" },
        { source_slug: "greenhouse", host: "job-boards.eu.greenhouse.io", setting_key: "board_tokens" },
        { source_slug: "lever", host: "jobs.lever.co", setting_key: "company_slugs" },
        { source_slug: "lever", host: "jobs.eu.lever.co", setting_key: "company_slugs" },
